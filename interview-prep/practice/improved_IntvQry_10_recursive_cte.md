...
- **Recursive CTE Structure**: Base case + Recursive case + Termination condition
- **Date arithmetic**: DATE_ADD() or INTERVAL operations
- **Row expansion**: Converting summarized data back to detailed rows
- **JOIN conditions**: Controlling recursion depth

## Interview Tips

- **Explain recursion**: "CTE calls itself until the condition is met"
- **Base vs recursive**: Always distinguish the starting case
- **Termination**: Explain how the recursion naturally ends
- **Alternative approaches**: Mention JOIN method as a non-recursive option
- **Performance**: Consider when recursion might be slow or hit limits

## Real-World Applications

- **Calendar expansion**: Converting "start_date + 7 days" to individual date rows
- **Sequence generation**: Creating numbered sequences based on counts
- **Time series creation**: Expanding summary data into time-based details
- **Report generation**: Converting aggregated metrics to detailed breakdowns
