...
2. **Incorrect JOIN order** → Performance issues
3. **NULL value handling** → Unexpected results
4. **Ambiguous column names** → Errors
5. **Missing indexes** → Slow queries

## Interview Tips

- **Explain JOIN types**: When to use each type
- **Performance considerations**: Index usage and query plans
- **NULL handling**: How JOINs handle missing data
- **Business logic**: Why certain JOINs are needed
- **Alternative approaches**: Subqueries vs JOINs

## Real-World Applications

- **E-commerce**: Customer order histories
- **CRM systems**: Customer interactions across channels
- **Inventory**: Product availability across locations
- **Financial**: Account transactions and balances
